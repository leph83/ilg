...
function wtp_scripts() {
    wp_enqueue_style('wtp-theme-style', get_template_directory_uri().'/css/style.min.css', '', '2020-03-07');
	wp_enqueue_script( 'wtp-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '2020-03-07', true );
	
	wp_enqueue_style('wtp-font', 'https://fonts.googleapis.com/css?family=Karla|Montserrat:300,700&display=swap', '', '2020-03-07');

	// if (!is_user_logged_in()) {
	// 	wp_enqueue_script( 'wtp-swup', get_template_directory_uri() . '/js/swup.min.js', array(), '2020-03-07', true );
	// 	wp_enqueue_script( 'wtp-swup-scroll', get_template_directory_uri() . '/js/SwupScrollPlugin.min.js', array(), '2020-03-07', true );
	// 	wp_enqueue_script( 'wtp-swup-init', get_template_directory_uri() . '/js/script.js', array(), '2020-03-07', true );
	// }
...
function wtp_admin_style() {
	...
	// extend gutenberg
	wp_enqueue_script( 'wtp-gutenberg-extension', get_template_directory_uri() . '/js/gutenberg-extension.js', array(), '2020-03-07', true );
}
